...
<div class="carousel-indicators">
    ...
    <button class="carousel-control-prev d-none" type="button" data-bs-target="#bannerCarousel" data-bs-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="visually-hidden">Previous</span>
    </button>
    <button class="carousel-control-next d-none" type="button" data-bs-target="#bannerCarousel" data-bs-slide="next">
